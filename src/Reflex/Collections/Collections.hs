...
type PatchSeqC f a = PatchSequenceable (SeqType f a) (SeqPatchType f a)
...
listViewWithKeyGeneral' ::  forall t m f v a. ( R.Adjustable t m
                                              , R.PostBuild t m
                                              , R.MonadHold t m
                                              , ToPatchType f 
                                              , PatchSeqC f a
...
selectViewListWithKeyGeneral :: forall t m f v a. ( R.Adjustable t m
                                                  , MonadFix m
                                                  , R.MonadHold t m
                                                  , R.PostBuild t m
...
sampledListWithKey :: forall t m f v a. ( R.Adjustable t m
                                        , R.PostBuild t m
                                        , MonadFix m
                                        , R.MonadHold t m
                                        , ToPatchType f  -- for the listHold
